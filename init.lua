...
ipnames.name_per_ip_limit = tonumber(minetest.setting_get("max_names_per_ip")) or 6
...
minetest.register_chatcommand("ipremove",{
	privs = { server = true },
	description = "Remove a playername from the managed IPs list",
	params = "<playername>",
	func = function(playername, args)
		-- If the player did not exist already,
		--   the table will effectively be unaltered
		ipnames.data[args] = nil
		ipnames.changes = true
		minetest.chat_send_player(playername, "Removing "..args)
	end
})
